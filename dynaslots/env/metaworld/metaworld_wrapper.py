...
from dynaslots.gym_util.mjpc_wrapper import point_cloud_sampling
...
class MetaWorldEnv(gym.Env):
    ...
    def __init__(self, task_name, device="cuda:0", 
        ...
        # Keep this equal to the recorded MetaWorld demonstrations (1024 by
        # default).  A caller may override it for a deliberate resolution
        # ablation, but the training/evaluation default should not silently
        # change the point-token distribution.
