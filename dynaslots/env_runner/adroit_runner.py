...
import torch
import tqdm
from dynaslots.env import AdroitEnv
from dynaslots.gym_util.mjpc_diffusion_wrapper import MujocoPointcloudWrapperAdroit
        ...
        for episode_idx in tqdm.tqdm(range(self.eval_episodes), desc=f"Eval in Adroit {self.task_name} Pointcloud Env",
            ...
            while not done:
                ...
                with torch.no_grad():
                    ...
                    obs_dict_input['image'] = obs_dict['image'].unsqueeze(0) ## youngadd
