...
from dynaslots.gym_util.mjpc_wrapper import MujocoPointcloudWrapperAdroit
...
def main():
    ...
    ###############################
    # create zarr file
    zarr_root = zarr.group(save_dir) #   压缩算法的设置
    ...
    compressor = zarr.Blosc(cname='zstd', clevel=3, shuffle=1) # zarr 数据压缩算法 2500条-> chunk_zise=100 -> 25个blocks 5100+ ->> 52      0.0.0-->25.0.0
